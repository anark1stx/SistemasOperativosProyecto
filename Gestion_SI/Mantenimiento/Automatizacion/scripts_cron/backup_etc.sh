...
rsync -e "ssh -i /home/admin/.ssh/id_rsa -p 49555" -arz --exclude 'gshadow' /etc admin@192.168.0.5:/backup/Linux/ && echo "Directorio ETC respaldado con exito" >> /logs/respaldos.log || echo "Hubo errores respaldando directorio h
