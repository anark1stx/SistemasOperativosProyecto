...
cp -R /var/Linux/home / && echo "Directorio home restaurado con exito" || echo "Hubo errores al sobreescribir el directorio home"
cp -R /var/Linux/etc / && echo "Directorio etc restaurado con exito" || echo "Hubo errores al sobreescribir el directorio etc"
rm -rf /var/Linux
